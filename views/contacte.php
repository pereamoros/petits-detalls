<?php
    ...
    $pagina_contacte = ltrim($correspondencies[0], "/");
    include_once BASE_PATH.'/dades/menu.php';
    include_once BASE_PATH.'/dades/'.$pagina_contacte.'.php';
...
<head>    
    ...
    <script>
        ...
        $(document).ready(function() {
            $("[name='form-contacte']").submit(function(e) {
                e.preventDefault();
                ...
                grecaptcha.ready(function() {
                    grecaptcha.execute(recaptcha_client_key, 
                        ...
                        $.ajax({
                            type: 'post',
                            url: '/src/ajax-controllers/form-contacte.php',
                            data: {
                                'name': name,
                                'email': email,
                                'telefon': telefon,
                            ...
                            success: function(data) {
                                ...
                                if(response.success) {
                                    document.querySelector('form[name="form-contacte"]').reset();
    ...
    <main>
        ...
        <section>
            <div class="container">
                ...
                <form class="form-container" method="post" name="form-contacte">
                    ...
                    <div class="form-item-container">
                        <div class="form-item">
                            ...
                            <textarea type="text" name="missatge" id="form-missatge" rows="5" required></textarea>
                        </div>
                    </div>
